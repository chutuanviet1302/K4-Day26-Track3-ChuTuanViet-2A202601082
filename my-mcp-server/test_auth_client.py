"""Client test cho Bước 5 — Kiểm tra Streamable HTTP Transport & Authentication (Bearer Token)."""
...
async def main() -> None:
    print("==================================================")
    print("🚀 BƯỚC 5 TEST: Authentication trên Streamable HTTP Transport")
    print("==================================================")
    ...
    if res1 and res2 and res3:
        print("🎉 TẤT CẢ TEST AUTHENTICATION ĐỀU ĐẠT CHUẨN!")
    else:
