"""Client test cho Bước 6 — Versioning & Metadata Resource (server://info)."""
...
async def main() -> None:
    ...
    print("==================================================")
    print("🚀 BƯỚC 6 TEST: Versioning & Metadata Resource (server://info)")
    print("==================================================")
    ...
    print("\n🎉 Bước 6 test hoàn thành tốt đẹp! Tương thích ngược & Versioning hoạt động xuất sắc.")
